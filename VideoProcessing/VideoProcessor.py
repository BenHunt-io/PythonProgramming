...
class VideoProcessor:
	...
	def __init__(self,
					...
					action_list_path = "action_annotation/overlap_labels.txt",
	...
	def get_annotations(self):
		...
		with open(self.action_annotation_path) as fin:
			for line in fin.readlines():
				...
				if(len(self.action_list) <= int(temp[2]))
				label = self.action_list[int(temp[2])-1] #Account for index starting at 0
